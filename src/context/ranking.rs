...
pub fn tokenize(text: &str) -> Vec<String> {
    const STOP: &[&str] = &[
        "the", "and", "for", "with", "this", "that", "from", "into", "when", "how", "what", "do",
        "does", "should", "need", "needs", "want", "wants", "a", "an", "are", "is", "be", "by",
        "of", "to", "in", "on", "at", "it", "its", "our", "your", "we", "you", "them", "their",
        "back", "again", "also", "just", "about", "have", "has", "had", "will", "would", "can",
        "could", "new", "some", "all", "any", "not", "please", "code", "if", "then", "else",
        "where", "there", "here", "up", "down", "over", "out", "under", "through", "than", "then",
        "as", "which", "while", "each", "more", "most", "other", "such", "only", "own", "same",
        "so", "too", "very",
    ];
