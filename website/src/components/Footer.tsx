      ...
      <div className="ctx-container flex flex-col gap-10 py-12 md:flex-row md:items-start md:justify-between">
        <div>
          <div className="flex items-center gap-2 font-mono">
            <span className="grid size-6 place-items-center rounded bg-ink text-xs font-bold text-white">
              &gt;_
            </span>
            <span>ctx</span>
          </div>
          <p className="mt-3 max-w-xs text-sm leading-6 text-ink-faint">
            Local code graph for AI coding agents. MCP over stdio — no daemon, no
            port, no telemetry, no network.
          </p>
        </div>
        <div className="grid grid-cols-2 gap-10 sm:grid-cols-3">
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              ...
              <li><Link href="/docs/install" className="text-ink-soft transition-colors hover:text-ink">Install</Link></li>
              <li><Link href="/docs/commands" className="text-ink-soft transition-colors hover:text-ink">Commands</Link></li>
              <li><Link href="/docs/architecture" className="text-ink-soft transition-colors hover:text-ink">Architecture</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              ...
              <li><a href="https://github.com/halloffame12/CTX/blob/main/CHANGELOG.md" target="_blank" rel="noreferrer" className="text-ink-soft transition-colors hover:text-ink">Changelog</a></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              ...
              <li><span className="text-ink-soft">v0.1.6</span></li>
              <li><span className="text-ink-soft">no telemetry</span></li>
              <li><span className="text-ink-soft">5 languages parsed</span></li>
            </ul>
          </div>
        </div>
      </div>
