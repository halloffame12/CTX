...
- **Output**: fully static export (`next.config.ts` sets `output: "export"`) with
  `basePath: "/CTX"` for GitHub Pages at
  [https://halloffame12.github.io/CTX/](https://halloffame12.github.io/CTX/).
